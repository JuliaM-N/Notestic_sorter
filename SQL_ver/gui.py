...
from storage_sql import load_notes, save_note, delete_note, load_categories, detect_category
...
class NoteApp:
    ...
    def add_note(self):
        ...
        note = {"text": text, "cat": category, "done": False}
        save_note(note)  # zapisujemy w SQL
        self.notes = load_notes()  # odświeżamy listę z bazy
    ...
    def render_notes(self):
        ...
        for note in filtered:
            ...
            btn_del = tk.Button(row, text="Usuń", command=remove_note)
